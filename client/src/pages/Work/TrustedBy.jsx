...
const TrustedBy = () => {
  return (
    <section
      id="trusted-by"
      className="relative w-full py-24 px-6 bg-gradient-to-b from-[#0a0a0a] via-[#111] to-[#0a0a0a] text-center overflow-hidden"
    >
      {/* Background Glow */}
      ...
      >
        ...
        <p className="text-gray-400 text-lg sm:text-xl">
          We proudly collaborate with India’s top education platforms, creators, influencers, and tech-driven brands.
        </p>
      </motion.header>
