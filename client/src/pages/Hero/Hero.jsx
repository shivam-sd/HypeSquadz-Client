...
const Hero = () => {
  return (
    <>
      ...
      <section className="relative w-full min-h-[100vh] sm:min-h-[100vh] lg:min-h-[130vh] flex items-center justify-center bg-gradient-to-b from-[#0a0a0a] via-[#111] to-[#1a1a1a] overflow-hidden pt-28 sm:pt-20 md:pt-32 lg:pt-5  py-10">
        {/* Background overlay */}
        ...
        <div className="relative z-10  text-center px-4 md:px-10 lg:px-12 max-w-7xl mx-auto">
          ...
          >
            {/* Static Button */}
            <button className="flex items-center gap-3 bg-gradient-to-b from-pink-400 to-orange-300 text-white font-semibold px-6 sm:px-8 py-3 sm:py-4 rounded-xl shadow-lg hover:scale-105 transition-transform duration-300 cursor-pointer">
              Idea
            </button>
          ...
          <div className="text-center flex flex-col sm:flex-row items-center justify-center gap-4 mt-8 sm:mt-10 px-4">
            ...
            >
              <button className="p-3 sm:p-4 rounded-lg border border-transparent hover:border-blue-500/35 text-base sm:text-lg font-bold w-full sm:w-48 bg-orange-500 cursor-pointer hover:bg-transparent duration-300 text-white hover:text-gray-400">
                See Our Work
              </button>
              <button className="p-3 sm:p-4 rounded-lg border border-blue-500/35 text-base sm:text-lg font-bold w-full sm:w-48 bg-white cursor-pointer hover:bg-orange-500 duration-300 text-orange-500 hover:text-white">
                Work With Us
              </button>
            </motion.div>
          </div>
